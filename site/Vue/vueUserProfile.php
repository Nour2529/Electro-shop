...
?>
                <div class="block-heading">
                    <h2 class="text-danger">Informations sur le profil</h2>
                    
                    
                </div>
                <div class="row">
                    <div class="col-md-6">
                    <img class="display" width=10% src=<?= $listUserProfile['chemin'] ?> alt="user_picture" title="user_picture"/><br>
                            ...
                            <form enctype="multipart/form-data" action="?action=userProfile" method="post">
                                <fieldset>
                                    ...
                                    <p>
                                        ...
                                        <input type="password" class="form-control"  name="old_password" id="old_password"/><br>
