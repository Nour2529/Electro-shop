			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="http://localhost/tp/img/shop01.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Laptop<br>Collection</h3>
								<a href="index.php?action=productCategorie&idsousCategorie=1" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="index.php?action=productCategorie&idsousCategorie=2" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="index.php?action=productCategorie&idsousCategorie=3" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
...
if (empty($ProduitList)) {
    ...
    <div class="product">
										...
										<h3 class="product-name"><a href="?action=productCategorie&id=<?php echo $Produit['produitID']; ?>"><?= $Produit['nomProduit']; ?></a></h3>
										<?php if($Produit['Solde']==NULL){?>
